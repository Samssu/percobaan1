...
<body>
    <section class="col">
        <div class="card shadow-sm h-100">
            <img src="/images/laravel.png" class="card-img-top p-3" alt="AWS">
            <div class="card-body">
                ...
                <div class="d-flex gap-3">
                    <a href="{{ route('profile-laravel') }}" class="btn btn-outline-primary btn-sm w-100">View</a>
                    <a href="{{ route('profile-laravel') }}" class="btn btn-primary btn-sm w-100">Join</a>
                </div>
            </div>
