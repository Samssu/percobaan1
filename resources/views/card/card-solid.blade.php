...
<body>
    <section class="col">
        <div class="card shadow-sm h-100">
            <img src="/images/bgsolid.webp" class="card-img-top p-3" alt="AWS">
            <div class="card-body">
                <h5 class="card-title">Solid Komunitas</h5>
                ...
                <div class="d-flex gap-3">
                    <a href="{{ route('profile-solid') }}" class="btn btn-outline-primary btn-sm w-100">View</a>
                    <a href="{{ route('profile-solid') }}" class="btn btn-primary btn-sm w-100">Join</a>
                </div>
            </div>
