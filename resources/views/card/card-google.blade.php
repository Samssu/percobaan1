...
<body>
    <section class="col">
        <div class="card shadow-sm h-100">
            ...
            <div class="card-body">
                <h5 class="card-title">Google developers Group</h5>
                ...
                <div class="d-flex gap-3">
                    <a href="{{ route('profile-google') }}" class="btn btn-outline-primary btn-sm w-100">View</a>
                    <a href="{{ route('profile-google') }}" class="btn btn-primary btn-sm w-100">Join</a>
                </div>
            </div>
