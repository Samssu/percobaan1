  ...
  <section class="col">
      <div class="card shadow-sm h-100">
          <img src="/images/react .png" class="card-img-top p-3" alt="Forum react">
          <div class="card-body">
              <h5 class="card-title mb-1">Forum react</h5>
              ...
              <!-- Button -->
              <a href="{{ route('profile-gallery-reactforum') }}" class="btn btn-primary btn-sm w-100 mt-2">See
                  Profile</a>
          </div>
