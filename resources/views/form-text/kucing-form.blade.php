         ...
         <div class="d-flex align-items-start">
             ...
             <div class="flex-grow-1">
                 ...
                 <p class="mt-3 mb-1">
                     ...
                     Saya ingin berbagi kabar tentang kucing terbaru yang membawa banyak keunikan diwebsite saya ini.
                 </p>
                 ...
                 <div class="image-container mt-3"
                     ...
                     <a href="{{ route('view-post', ['id' => 1]) }}"
                         onclick="openImageFullscreen(event, '/images/oyen.jpg')">
                         <img id="fullscreen-1" src="/images/oyen.jpg" alt="Deskripsi Gambar 1"
