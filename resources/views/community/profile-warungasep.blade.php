        ...
        <div class="card mb-4 border-0 shadow-sm" style="margin-right: 110px;">
            <div class="card-body p-0">
                ...
                <div class="position-relative" style="height: 350px;">
                    <img src="/images/bgbangasep.webp" alt="Community Cover" class="w-100 h-100"
                        style="object-fit: cover;">
                    <!-- Community Logo -->
                    <img src="/images/warungasep.webp" alt="Community Logo"
                ...
                <div class="pt-5 px-4 pb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <!-- Judul -->
                            <h3 class="fw-bold">Warung Asep</h3>
                            ...
                            <a href="#" class="btn"
                                style="font-size: 0.7rem; padding: 5px 10px; background-color: #D0E8C5  ; color: white; border-radius: 50px; margin-top: 9px; text-decoration: none; opacity: 1; transition: opacity 0.3s; font-weight: bold;">
                                Warkop
                            </a>
                        </div>
